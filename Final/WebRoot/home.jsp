...
<head>
<title>: : shihang design company home have log in : :</title>
...
<div id="dvmaincontainer">
  ...
  <div id="dvbodycontainer">
    ...
    <div id="dvbannerbgcontainer">
      ...
      <div id="dvbanner">
        ...
        <img src="images/banner.jpg"  alt="" width="500" height="230" title=""/>
        
        
        
        
        <a href="http:www.baidu.com.cn/">here us link</a>
    ...
    <div id="dvleftpanel">
      ...
      <div id="midcont">
        ...
        <p><span>- Bluse Hang shihang</span></p>
    ...
    <div id="dvrightpanel">
      ...
      <h1>Leader in E-Commerce Solutions of deisning your Lamp</h1>
      <%String username = (String)session.getAttribute("username"); %>
      <p>Welcome, <%= username %>, We are an eco based web and logo design company. Our main focus is working with companies that are green friendly. We specialize in getting businesses onto the Internet quickly and professionally. From custom logo identity, to fully branded web and print, we can take your business to success!</p>
    ...
    <div class="learn"><span><a href="message.jsp">LEARN MORE</a></span></div>
  ...
  <div id="dvfootercontainer">
    ...
    <div id="foottop">
      <p><span>Copyright ~ 2015 2015.7.7 shihang design </span> <a href="#" title="Home">Home</a><a href="#" title="Services">Services</a><a href="#" title="Portfolio">Portfolio</a><a href="#" title="Blog">Blog</a><a href="apple_watch.pdf">Eco Web Design by Shihang</a></p>
