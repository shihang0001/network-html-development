...
<html>
  <head>
    <base href="<%=basePath%>">
    <title>: : shihang design company have log in : :</title>
  ...
  <div id="dvbodycontainer">
    ...
    <div id="dvbannerbgcontainer">
      ...
      <div id="dvbanner">
        ...
        <img src="images/shicompany.png" width="762" height="218"  alt=""/>        <!-- banner div ends here-->
      </div>
...
<p>sihihaghd</p>
<h4>change or getting the label</h4>
           </div>
    ...
    <div id="dvrightpanel">
      ...
      <h1> The hope and wishes of huaman 's life change--------hang</h1>
      <p>We are an eco based web and logo design company. Our main focus is working with companies that are green friendly. We specialize in getting businesses onto the Internet quickly and professionally. From custom logo identity, to fully branded web and print, we can take your business to success!When I was young I guess </p>
  ...
  <div id="dvfootercontainer">
    ...
    <div id="foottop">
      <p><span>Copyright „1¤7 2015 2015.7.7 shihang design </span> <a href="#" title="Home">Home</a><a href="#" title="Services">Services</a><a href="#" title="Portfolio">Portfolio</a><a href="#" title="Blog">Blog</a><a href="http://www.studio7designs.com">Eco Web Design by Shihang</a></p>
