...
import="jspservlet.dao.PurchaseDAO" import="jspservlet.dao.impl.PurchaseDAOImpl"
...
<html> 
	<head>
<title>: : shihang design company shoppingcart : :</title>
...
<div id="dvmaincontainer">
  ...
  <div id="dvtopcontainer">
    ...
    <div id="dvnavicontainer">
      ...
      <img src="images/navi_left.jpg" alt="" />
        ...
        <ul>
          <!-- CSS Tabs -->
          <li id="current"><a href="home.jsp"><span>Home</span></a></li>
          <li><a href="shoppingCart.jsp"><span>Cart</span></a></li>
          <li><a href="Dgproduct.jsp"><span>Product </span></a>

          </li>                              
          <li><a href="product.jsp"><span>V-mall</span></a></li>
          <li><a href="company.jsp"><span>About Us</span></a></li>
        </ul>
      </div>
 ...
 <div class="rightX">
        ...
        <div class="rTitle">
		<h3> Product Introduction shopping cart </h3>
		<h4>You can also have are lists to see the shopping cart below.</h4>
		</div>
		<div class="rContent">
			<div class="productX">
				<img src="./images/l05.jpg" height="195"/>
			...
			<div class="productX">
				<img src="./images/l06.jpg" height="195">
              <label><input name="Fruit" type="checkbox" value="" />
			...
			<div class="productX">
				<img src="./images/l04.jpg" height="210">
	...
	<p> 
	    <h3> You can see the purches or unpurches things here~ 	</h3>			
...
<%String username = (String)session.getAttribute("username");
    ...
    <%=paidList.get(i).getAddress() %>
    
    <img src="<%=paidList.get(i).getAddress() %>"height="194"><br/>
    
    color:<%=paidList.get(i).getColor() %><br/>

    height:<%= paidList.get(i).getHeight() %>

    price: <%=paidList.get(i).getPrice() %>

    <input type="HIDDEN" name="id" value="<%=paidList.get(i).getId()%>"><br/>
    ...
    <form action="./delete" method="post">
     <img src="<%=unpaidList.get(i).getAddress() %>"height="194"><br/>
    <%=unpaidList.get(i).getAddress() %>

    color:<%=unpaidList.get(i).getColor() %><br/>

    height:<%= unpaidList.get(i).getHeight() %>

    price: <%=unpaidList.get(i).getPrice() %>

    <input type="HIDDEN" name="id" value="<%=unpaidList.get(i).getId()%>"><br/>
   ...
   <form action="./settleAcc" method="post">

    <input type="SUBMIT" name="submit" value="Settle Accounts"><br/>
	...
	<a href="shoppingCart.jsp">  <img src="images/sp01.jpg" width="66" height="64"  alt=""/>CLICK HERE ! Be sure to see more in the v-mall! </a>
